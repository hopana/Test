...
public class ThreadPoolExecutorRejectNewTaskDemo {
    ...
    /** 线程池对象 */
    private static final ThreadPoolExecutor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(MAX_POOL_SIZE, MAX_POOL_SIZE, KEEP_ALIVE_TIME_VALUE, TimeUnit.SECONDS, new LinkedBlockingQueue<>(QUEUE_CAPACITY), new MyThreadFactory(), new MyRejectPolicy());
    ...
    public static class MyRejectPolicy implements RejectedExecutionHandler {
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            ...
            if (r instanceof MyRunnable) {
                MyRunnable thread = (MyRunnable) r;
                //直接打印
                System.out.println("线程被拒绝：" + thread.toString());
            }
        }
    }
