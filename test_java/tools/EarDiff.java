...
public class EarDiff {
    ...
    public static void main(String[] args) {
        ...
        long elapsed = 0;
        try {
            String filePath1 = "D:\\sppay-admin-war-1.135.war";
            String filePath2 = "D:\\sppay-admin-war-1.150.war";
            System.out.println("Comparing " + filePath1 + " against " + filePath2);
            EarDiff diff = new EarDiff(filePath1, filePath2);
            same = diff.compare();
