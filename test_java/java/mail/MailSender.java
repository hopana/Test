...
public class MailSender {
    ...
    public static class Builder {
        ...
        //发件人地址
        private String fromAddress = "hopana@163.com";
        //发件账户密码
        private String fromCount = "hopana";
        private String fromPassword = "8y2b4y7abc";
    ...
    private MailSender(Builder builder) throws Exception {
        ...
        msg.setFrom(new InternetAddress(builder.fromAddress, "hihoCoder用户注册邮箱验证"));
