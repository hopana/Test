 ...
 * UnicodeMaxIntValue that chains never meet
 * UnicodeMaxIntValue that chain meets only once
 * UnicodeMaxIntValue that chain meets multipe times
 * UnicodeMaxIntValue that one chain ends where it meets chain 2
 */
