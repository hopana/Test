...
import com.hp.model.A;
import com.hp.model.B;
import com.hp.model.User;
import com.hp.model.Word;
...
public class SerializerFeatureTest {
     ...
     */
    public static void cycleReference() {
        A a = new A();
        B b = new B(a);
        a.setB(b);
        // 输出 {"b":{"a":{"$ref":".."}}}
    ...
    private static void showJsonBySelf() {
        ...
        System.out.println(JSON.toJSONString(word, SerializerFeature.PrettyFormat, SerializerFeature.WriteMapNullValue, SerializerFeature.WriteNullStringAsEmpty, SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteNullListAsEmpty));
    }
